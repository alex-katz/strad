...
🔵 **Отражения** | ↔️ На себя | 🗣️ ✋ | ⏳ 1 минута
3 иллюзорных копии (КД = 10 + ЛОВ).
Когда вас атакуют, бросьте d20.
-   **3 копии:** 6+ атака по копии
-   **2 копии:** 8+ атака по копии
-   **1 копия:** 11+ атака по копии
При попадании копия исчезает.
